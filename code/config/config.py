...
BENCHMARK_ROOT = Path("/datadrive/josephtang/SEAM/code/data")
...
MAX_NUM_SEQS = 64  # Maximum number of sequences processed concurrently (default: 256, reduce for large vision models)
