...
# SEAM Benchmark - Complete Pipeline for All Models
# This script runs the full 3-stage pipeline: Inference (01) -> Extraction (02) -> Metrics (03)
#
# Usage:
#   ./run_all_models.sh
#
# To enable/disable models:
#   - Comment out models you don't want to run (add # at the beginning)
#   - Uncomment models you want to run (remove # from the beginning)
...
# Models to run - organized by provider
VLLM_MODELS=(
